...
export interface AxiosProps {
  /** 请求的域名等 */
  requestConfig?: RequestConfigProps | any
  /** 超时的时间 */
  timeout?: number
  /** 关闭取消重复请求： 默认false 不关闭 */
  closeCancelRequest?: boolean
   ...
   * @returns {Promise<any>}
   */
  onHandleResponseData?: <T>(response: AxiosTypes<ResponseTypes<T>>, config?: RequestMethodProps, axios?: any) => Promise<T>
  handleSign?: (params: any) => string
}
